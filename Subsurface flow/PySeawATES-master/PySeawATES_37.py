...
os.chdir(r'C:\Users\924878\Documents\Subsurface flow\PySeawATES-master')     # Set the proper working directory (WD)
...
excel_filename = 'well_dataAXI_citg.xlsx'      #- change this -#                      # in this XLS you set your basis ATES and subsurface characteristics. set to 3D/AXI accordingly in l58

'''Set name for run''' 
naam = 'CITG'
case = 'versie_2_5_years_axi' 
name = naam + case
